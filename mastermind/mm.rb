...
def make_code
 ...
 | (__/ _ \\/ _` / -_) | |\\/| / _` | / / -_) '_|
  \\___\\___/\\__,_\\___| |_|  |_\\__,_|_\\_\\___|_|  
                                                      "
  puts "Create a secret code made up of a sequence of four pegs from any of the following colors: Black, White, Red, \
...
def request_user_code
  ...
  while !check_for_valid(code)
    puts "\nAt least one of your code elements was invalid, please enter FOUR colors separated by a single space like this \"green black white red\".  \n"
    code = gets.chomp.downcase.split(' ')
  end
 return code
end
